import 'dart:convert';
import 'package:projek1/model/model_sholawat.dart';
...
class _sholawatState extends State<sholawat> {
  Future<List<ModelSholawat>> ReadJsonData() async {
    final jsondata =
        await rootBundle.rootBundle.loadString('assets/data/sholawat.json');
    final list = json.decode(jsondata) as List<dynamic>;
    return list.map((e) => ModelSholawat.fromJson(e)).toList();
  }
                ...
                child: FutureBuilder(
                  ...
                  builder: (context, data) {
                    if (data.hasError) {
                      ...
                      var items = data.data as List<ModelSholawat>;
